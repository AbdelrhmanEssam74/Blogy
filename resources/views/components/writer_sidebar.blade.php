<aside class="sidebar">
    ...
    <div class="sidebar-menu" id="sidebarMenu">
        <a href="{{ route('writer.dashboard') }}" class="menu-item {{ request()->routeIs('writer.dashboard') ? 'active' : '' }}" data-target="dashboard">
            <i class="fas fa-home"></i>
            <span>Dashboard</span>
        </a>
        <a href="{{ route('writer.create') }}" class="menu-item {{ request()->routeIs('writer.create') ? 'active' : '' }}" data-target="new-post">
